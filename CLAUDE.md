...
- `participants/` — everything a participant may need to read: `ARCHITECTURE.md` (system-level deep dive referenced above), `exercises_answer_key.ipynb` (worked answers to `exercises.md`, for self-checking), and `LOCAL_SETUP_GUIDE.md` (the participant-facing half of the local/custom-data track). `participants/README.md` indexes all of it.
